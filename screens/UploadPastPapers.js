...
import { Text, View,ScrollView, 
  Platform, StyleSheet, TouchableWithoutFeedback, Keyboard, Alert,
...
const UploadPastPapers = ({navigation})=>{
  ...
  `Struggle to understand/solve specific questions? . No problem, our tutors got your back.
Request to get help from our best tutors in this course, at the lowest price, pay only R70 per Session.`
  ...
  return (
    <Formik
        ...
        onSubmit={async (values, { resetForm }) => {
          ...
          let pdfsFilePath = [questionsFilePath, ...solutionsFilePath ] // combine for uploading to the bucket
          let pdfsFileData = [questionsPdf, ...solutionsPdf] // combine for uploading to the bucket
        ...
        <TouchableWithoutFeedback onPress={()=>Keyboard.dismiss()} >
          <ScrollView contentContainerStyle={styles.innerContainer}>
            ...
            <View>
              ...
              <View style={styles.btnsView}>
                <SmallButton title="Past Papers Questions" color="#0690f5" onPress={async()=> await pickDocuments("questions")}/>               
              ...
              <View style={{borderWidth: 1,paddingVertical: 10,paddingHorizontal:3 }}>
                ...
                <View style={{flexDirection: 'row'}}>
                  <SmallButton title="Past Papers Solutions" color="#0690f5" onPress={async()=> await pickDocuments("solutions")}/>
              ...
              <Text style={styles.label}>Select instutions</Text>
              <SelectList
