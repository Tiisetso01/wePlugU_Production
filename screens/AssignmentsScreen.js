...
const AssignmentsScreen = ({navigation, route}) => {
  ...
  let isSubscribed = customerInfo?.entitlements?.active.course_material;
 ...
 useIsFocused()
  ...
  if(posts.length == 0) return <NoDataMessage message="No Assignments Posts For This Course Yet."/>
  return (
      ...
      <FlatList
        ...
        renderItem={({item:post})=>(
          <View style={styles.container}>
            <Text style={styles.sampleText}>Pictures of Sample Assignment Solutions</Text>
            ...
            <View style={styles.imageContent}>
              ...
              <Text style={[styles.label,{marginTop:10}]}>Solutions: (Download)</Text>
              {
                  ...
                  <GifButton
                    ...
                    onPress={async()=>{
                      if(isSubscribed !== undefined){
                        Linking.openURL(post.solutionsFilePath[index])
                        //return await openSolutions(post.solutionsFilePath[index])
                      }
                      navigation.navigate("coursesPaywall", {pdfPath: post.solutionsFilePath[index]})
              ...
              <View style={{alignSelf:'center', marginBottom:10}}>
                ...
                <SmallButton 
                  title="Request for help" color="blue" 
